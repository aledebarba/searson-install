...
class Settings_General extends \ShopWP\DB
{
    ...
    public function __construct()
    {
        ...
        $this->default_cart_counter_color = SHOPWP_DEFAULT_CART_COUNTER_COLOR;
        $this->default_cart_icon_color = SHOPWP_DEFAULT_CART_ICON_COLOR;
        $this->default_inline_cart_counter_text_color = SHOPWP_DEFAULT_INLINE_CART_COUNTER_TEXT_COLOR;
        $this->default_cart_icon_fixed_color = SHOPWP_DEFAULT_CART_ICON_FIXED_COLOR;
        $this->default_cart_counter_fixed_color = SHOPWP_DEFAULT_CART_COUNTER_FIXED_COLOR;
        $this->default_cart_fixed_background_color = SHOPWP_DEFAULT_CART_FIXED_BACKGROUND_COLOR;
