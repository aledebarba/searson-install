...
class Settings_Syncing extends \ShopWP\DB
{
    ...
    public function syncing_totals()
    {
        return [
            ...
            'media' => $this->get_syncing_totals_media(),
        ];
    }
    ...
    public function set_syncing_totals($counts, $exclusions = [])
    {
        ...
        $operations = [
            ...
            'webhooks' => $this->update_col('syncing_totals_webhooks', $webhooks_totals)
        ];
    ...
    public function reset_syncing_totals()
    {
        return [
            ...
            'webhooks' => $this->update_col('syncing_totals_webhooks', 0),
            'media' => $this->update_col('syncing_totals_media', 0),
            'percent_completed_removal' => $this->update_col('percent_completed_removal', 0),
            'syncing_totals_removal' => $this->update_col('syncing_totals_removal', 0),
        ];
    }
    ...
    public function syncing_current_amounts()
    {
        return [
            ...
            'media' => $this->get_syncing_current_amounts_media(),
        ];
    }
    ...
    public function reset_syncing_current_amounts()
    {
        return [
            ...
            'webhooks' => $this->update_col('syncing_current_amounts_webhooks', 0),
            'media' => $this->update_col('syncing_current_amounts_media', 0),
        ];
    }
    ...
    {
        return [
            'media_refs' => $this->update_col('recently_syncd_media_ref', ''),
        ];
    }
