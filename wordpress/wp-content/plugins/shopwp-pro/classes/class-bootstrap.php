...
class Bootstrap
{
    ...
    public function build_plugin($plugin_settings, $results)
    {
        ...
        ] = Factories\API\Items\Cart_Factory::build();
        ...
        $results[
            'API_Items_Webhooks_Factory'
        ] = Factories\API\Items\Webhooks_Factory::build();

        $results[
            'API_Processing_Webhooks_Factory'
        ] = Factories\API\Processing\Webhooks_Factory::build();
        $results[
            'API_Processing_Webhooks_Deletions_Factory'
        ] = Factories\API\Processing\Webhooks_Deletions_Factory::build();

        $results[
            'API_Items_Media_Uploader_Factory'
        ] = Factories\API\Items\Media_Uploader_Factory::build();
