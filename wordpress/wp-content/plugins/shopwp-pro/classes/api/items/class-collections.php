...
class Collections extends \ShopWP\API
{
	...
	*/
    ...
    public function show_metafield($request) {

        $key = $request->get_param('key');
        $namespace = $request->get_param('namespace');

        $response = $this->Admin_API_Metafields->show_metafield($key, $namespace);

        if (is_wp_error($response)) {
            return wp_send_json_error($response);
        }

        $metafield_id = $response->metafieldStorefrontVisibilityCreate->metafieldStorefrontVisibility->id;
    ...
    public function hide_metafield($request) {

        $metafield_id = $request->get_param('id');
        
        $hide_result = $this->Admin_API_Metafields->hide_metafield($metafield_id);
    ...
    public function get_collections($request) {
        ...
        $query_params = apply_filters('shopwp_get_collections_query_params', $query_params);
        ...
        $result = $this->Storefront_Collections->get_collections($query_params);
	...
	*/
    public function get_all_collections($request)
    {
        ...
        if (!$has_connection) {
            return wp_send_json_error(Messages::get('connection_not_found') . ' (get_all_collections)');
        }
	...
	*/
    ...
    public function register_route_query_collections()
    {
        return register_rest_route(
            SHOPWP_SHOPIFY_API_NAMESPACE,
            '/query/collections',
    ...
    public function register_route_show_metafield()
    {
        return register_rest_route(
            SHOPWP_SHOPIFY_API_NAMESPACE,
            '/metafields/show',
    ...
    public function register_route_hide_metafield()
    {
        return register_rest_route(
            SHOPWP_SHOPIFY_API_NAMESPACE,
            '/metafields/hide',
    ...
    public function init()
    {
        ...
        add_action('rest_api_init', [$this, 'register_route_query_collections']);
        

        add_action('rest_api_init', [$this, 'register_route_show_metafield']);
        add_action('rest_api_init', [$this, 'register_route_hide_metafield']);
    }
}
