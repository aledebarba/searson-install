    ...
    public function __construct()
    {
		...
		*/
        self::$unable_to_cache_checkout = __(
            'ShopWP Warning: Unable to cache checkout.',
            'wpshopify'
        );
        self::$missing_checkout_id = __(
            'ShopWP Warning: Can\'t find checkout id to cache.',
            'wpshopify'
        );
        self::$delete_single_product_cache = __(
            'ShopWP Warning: Unable to delete single product cache.',
            'wpshopify'
        );
        self::$delete_single_product_images_cache = __(
            'ShopWP Warning: Unable to delete single product images cache.',
            'wpshopify'
        );
        self::$delete_single_product_tags_cache = __(
            'ShopWP Warning: Unable to delete single product tags cache.',
            'wpshopify'
        );
        self::$delete_single_product_variants_cache = __(
            'ShopWP Warning: Unable to delete single product variants cache.',
            'wpshopify'
        );
        self::$delete_single_product_options_cache = __(
            'ShopWP Warning: Unable to delete single product options cache.',
            'wpshopify'
        );
        self::$delete_product_prices = __(
            'ShopWP Warning: Unable to delete cached product prices.',
            'wpshopify'
        );
        self::$delete_cached_settings = __(
            'ShopWP Warning: Unable to delete cached settings.',
            'wpshopify'
        );
        self::$delete_cached_admin_notices = __(
            'ShopWP Warning: Unable to delete cached admin notices.',
            'wpshopify'
        );
        self::$delete_cached_connection = __(
            'ShopWP Warning: Unable to delete cached connection.',
            'wpshopify'
        );
        self::$delete_cached_collection_queries = __(
            'ShopWP Warning: Unable to delete cached collection queries.',
            'wpshopify'
        );
        self::$delete_single_collection_cache = __(
            'ShopWP Warning: Unable to delete single cached collection.',
            'wpshopify'
        );
        self::$delete_single_collections_cache = __(
            'ShopWP Warning: Unable to delete all cached single collections.',
            'wpshopify'
        );
        self::$delete_cached_products_queries = __(
            'ShopWP Warning: Unable to delete cached product queries.',
            'wpshopify'
        );
        self::$delete_plugin_cache = __(
            'ShopWP Warning: Unable to delete all cache, please try again.',
            'wpshopify'
        );
        self::$delete_cache_general = __(
            'ShopWP Warning: Unable to delete general plugin cache, please try again.',
            'wpshopify'
        );
        self::$delete_product_data_cache = __(
            'ShopWP Warning: Unable to delete single product data cache. Make sure to manually clear via ShopWP - Tools.',
            'wpshopify'
        );
        ...
        self::$syncing_docs_check = __(
            '<p class="wps-syncing-docs-check">🔮 <a href="https://docs.wpshop.io/#/getting-started/common-issues" target="_blank">Check the documentation</a> for a possible solution to this error.</a></p>',
            'wpshopify'
        );
