...
$(document).ready(function(){
    ...
    $('.search-modal .box-close').click(function() {
...
$(document).ready(function(){
	$('li.has-sub-menu').click(function(e) {
        if (
            e.clientX > $(this).offset().left + 60 &&
            e.clientY < $(this).offset().top + 100
        ) {
            $(this).find('li.has-sub-menu').toggleClass('sub-menu-open');
...
$(document).ready(function() {
    $('.lightbox-gallery').magnificPopup({
        ...
        gallery:{
            enabled: true,
            //arrowMarkup: '<button title="%title%" type="button" class="fal fa-chevron-%dir%"></button>',
        }
    });
...
// Salvattore 1.0.9 by @rnmp and @ppold -- https://github.com/rnmp/salvattore //
